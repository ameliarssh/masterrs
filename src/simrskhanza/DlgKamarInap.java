...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    public DlgKamarInap(java.awt.Frame parent, boolean modal) {
        ...
        PenanggungJawab.setDocument(new batasInput((int)100).getKata(PenanggungJawab));
        ...
        WindowPenanggungJawab.setSize(630, 80);
    ...
    private void initComponents() {
        ...
        MnJawab = new javax.swing.JMenuItem();
        ...
        WindowPenanggungJawab = new javax.swing.JDialog();
        ...
        TKdBngsal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TKdBngsalActionPerformed(evt);
            }
        });
        ...
        MnJawab.setBackground(new java.awt.Color(255, 255, 254));
        MnJawab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnJawab.setForeground(new java.awt.Color(50, 50, 50));
        MnJawab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnJawab.setText("Penanggung Jawab");
        MnJawab.setAutoscrolls(true);
        MnJawab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnJawab.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnJawab.setName("MnJawab"); // NOI18N
        MnJawab.setPreferredSize(new java.awt.Dimension(220, 26));
        MnJawab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnJawabActionPerformed(evt);
            }
        });
        MnGanti.add(MnJawab);
        ...
        DiagnosaAwalSementara.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DiagnosaAwalSementaraActionPerformed(evt);
            }
        });
        ...
        DiagnosaAkhirSementara.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DiagnosaAkhirSementaraActionPerformed(evt);
            }
        });
        ...
        WindowPenanggungJawab.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowPenanggungJawab.setName("WindowPenanggungJawab"); // NOI18N
        WindowPenanggungJawab.setUndecorated(true);
        WindowPenanggungJawab.setResizable(false);

        internalFrame10.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ganti Penanggung Jawab ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnCloseIn7.setBounds(510, 30, 100, 30);
        ...
        BtnSimpan7.setBounds(405, 30, 100, 30);

        jLabel41.setText("Penanggung Jawab");
        jLabel41.setName("jLabel41"); // NOI18N
        internalFrame10.add(jLabel41);
        jLabel41.setBounds(0, 32, 95, 23);
        ...
        PenanggungJawab.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PenanggungJawabKeyPressed(evt);
            }
        });
        internalFrame10.add(PenanggungJawab);
        PenanggungJawab.setBounds(99, 32, 290, 23);

        WindowPenanggungJawab.getContentPane().add(internalFrame10, java.awt.BorderLayout.CENTER);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-06-2021" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-06-2021" }));
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
    ...
    private void DiagnosaAwalSementaraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DiagnosaAwalSementaraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagnosaAwalSementaraActionPerformed

    private void BtnCloseIn7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCloseIn7ActionPerformed
        WindowPenanggungJawab.dispose();
    ...
    private void BtnSimpan7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan7ActionPerformed
        if (norawat.getText().trim().equals("")) {
            ...
            Sequel.mengedit("reg_periksa", "no_rawat=?", "p_jawab=?", 2, new String[]{PenanggungJawab.getText(), norawat.getText()});
            tampil();
            WindowPenanggungJawab.dispose();
        }
    ...
    private void PenanggungJawabKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenanggungJawabKeyPressed
        Valid.pindah(evt, BtnCloseIn7, BtnSimpan7);
    }//GEN-LAST:event_PenanggungJawabKeyPressed
    ...
    private void MnJawabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnJawabActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else if (norawat.getText().trim().equals("")) {
            ...
            if (tbKamIn.getSelectedRow() > -1) {
                WindowPenanggungJawab.setLocationRelativeTo(internalFrame1);
                WindowPenanggungJawab.setVisible(true);
            }
        }
    }//GEN-LAST:event_MnJawabActionPerformed

    private void DiagnosaAkhirSementaraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DiagnosaAkhirSementaraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagnosaAkhirSementaraActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnJawab;
    ...
    private javax.swing.JDialog WindowPenanggungJawab;
